...
Find my work in: 
- [LaTex Extended UserManual](https://github.com/Aves-Frog/LaTex-extended-user-manual)
- [Flipper Zero and Misc](https://github.com/Aves-Frog/Aves-Flipper)

Current activity:
- 📘 Currently writing LaTex extended user manual
- 📁 Currently building a framework for Physical Pentesting Reports in LaTex
